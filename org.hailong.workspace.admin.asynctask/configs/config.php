	...
	return array(
		"services" => array(
			array(
				...
				"config" => array(
					"entitys"=>array("DBAccount","DBUserViewState","DBAuthority","DBAuthorityRole","DBAuthorityEntity","DBLog","DBAsyncTask")
				),
				"createInstance" =>true,
			),
			array(
			...
			array(
				...
				"tasks" => array(
					"AsyncActiveTask","AsyncResetTask","AsyncCleanupTask"
				),
			),
		),
	);
