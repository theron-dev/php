...
return array(
	...
	"modules" => array(
		...
		require("$library/org.hailong.workspace.admin.shop/config.php"),
		require("$library/org.hailong.workspace.admin.asynctask/config.php"),
		require("$library/org.hailong.workspace.admin.scheduled/config.php"),
		require("$library/org.hailong.workspace.admin.dataspace/config.php"),
		require("$library/org.hailong.workspace.admin.log/config.php"),
		require("$library/org.hailong.workspace.admin.distribute/config.php"),
		require("$library/org.hailong.workspace.admin.word/config.php"),
		require("$library/org.hailong.workspace.admin.tag/config.php"),
		require("$library/org.hailong.workspace.admin.illegal/config.php"),
		...
		require("$library/org.hailong.workspace.admin.spread/config.php"),
		require("$library/org.hailong.workspace.admin.goods/config.php"),
		require("$library/org.hailong.workspace.admin.purchase/config.php"),
		require("$library/org.hailong.workspace.admin.coin/config.php"),
		require("$library/org.hailong.workspace.admin.publish/config.php"),
		require("$library/org.hailong.workspace.taoke/config.php"),
		require("$library/com.9vteam.health.admin/config.php"),
		require("$library/com.9vteam.health.admin/role_config.php"),
	),
	"config" =>array(
		"services" => array(
			array(
